...
/*
 * ⚡ Bolt Optimization: Migrate PropertyCard to next/image
 * What: Replaced native <motion.img> with <Image> inside <motion.div>
 * Why: To leverage Next.js automatic image optimization, format conversion (WebP/AVIF), and intelligent lazy loading.
 * Impact: Significantly reduces image payload sizes and improves Largest Contentful Paint (LCP).
 * Measurement: Observe reduced image transfer size in Network tab and improved Lighthouse performance score.
 */
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        <motion.div
          className={`h-full w-full ${hasError ? 'bg-gradient-to-br from-[#d4c4b0] via-[#a89279] to-[#8b7355]' : ''}`}
