  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        >
          {/* Performance Optimization: Replaced native <img> with next/image <Image /> component.
              This provides automatic lazy loading, optimal image formats (e.g., WebP/AVIF),
              and responsive sizing based on 'sizes', significantly improving LCP (Largest Contentful Paint)
              and reducing bandwidth usage by preventing loading of unoptimized, full-size images. */}
          <Image
            src={image}
            alt={title}
            fill
