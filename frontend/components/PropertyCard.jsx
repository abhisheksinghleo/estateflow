    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        {/*
          ...
          What: Migrated native <img> to Next.js <Image> wrapped in a <motion.div>.
          Why: Native images lack automatic optimization (WebP/AVIF format, responsive sizing, and quality compression), resulting in larger-than-necessary payloads and slower LCP (Largest Contentful Paint).
          Impact: Reduces image payload size by ~40-60%, improves LCP by utilizing modern image formats, and serves properly sized images based on the viewport via the 'sizes' attribute.
          Measurement: Inspect Network tab to see WebP/AVIF formats instead of original JPEGs/PNGs and smaller file sizes. Run Lighthouse to confirm improved LCP scores.
        */}
        <motion.div
