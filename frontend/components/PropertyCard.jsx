  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        {/* ⚡ Bolt Optimization: Replace native <img> with next/image for automatic optimization (WebP/AVIF, resizing, lazy loading). We wrap it in a motion.div to preserve Framer Motion animations cleanly. */}
        <motion.div
        ...
        >
          <Image
            ...
            onError={(e) => {
              ...
              // ⚡ Bolt fix: Explicitly clear the generated srcset, otherwise the browser
              // will prioritize the srcset over our fallback src
              e.target.srcset = "";
