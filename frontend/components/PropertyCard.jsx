  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        {/*
          ⚡ Bolt Optimization: Migrated native <img> to Next.js <Image> for automatic WebP conversion,
          responsive sizing, and improved LCP. Wrapped in <motion.div> to preserve Framer Motion animations.
        */}
        <motion.div
        ...
        >
          <Image
            ...
            onError={(e) => {
              ...
              e.target.srcset = ""; // Important: clear srcset to allow fallback src to load
