  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        {/* ⚡ Bolt Optimization: Wrapped in motion.div to preserve hover animation while using Next.js Image for automatic optimization. */}
        <motion.div
          className="relative h-full w-full"
          whileHover={shouldReduceMotion ? {} : { scale: 1.04 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
        >
          {/* ⚡ Bolt Optimization: Migrated native <img> to next/image.
              Impact: Automatically serves WebP, responsive sizing based on 'sizes' attr, and prevents layout shift.
              Expected Improvement: Reduces LCP time and image payload size significantly. */}
          <Image
            src={image}
            alt={title}
            fill
