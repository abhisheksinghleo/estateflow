...
export default function PropertyCard({ property }) {
  ...
  return (
    ...
    >
      {/* Image */}
      {/* ⚡ Bolt Optimization: Migrated native <img> to next/image inside motion.div with sizes prop and cleared srcset in onError.
          Impact: Decreases LCP by loading properly sized responsive WebP images instead of full-size originals. */}
        ...
        >
          <Image
            ...
            onError={(e) => {
              ...
              e.target.srcset = ""; // explicitly clear srcset for fallback to work
