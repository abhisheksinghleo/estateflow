...
export default function PropertyCard({ property }) {
  ...
  return (
    ...
    >
      {/* Image */}
      {/*
        * 💡 What: Migrated from native <img> to next/image inside a <motion.div>.
        * 🎯 Why: Replaced unoptimized native <img> tag with next/image. Native <img> tags can cause layout shifts and download full resolution images regardless of viewport size, which leads to large data transfers, especially on mobile. Using Next.js Image component provides automatic image optimization (WebP/AVIF), lazy loading, and responsive sizing using `sizes`.
        * 📊 Impact: Significantly reduces image payload sizes on smaller viewports and modern browsers. Prevents layout shifts.
        * 🔬 Measurement: Observe network panel in dev tools to see optimized image formats (webp/avif) and smaller file sizes relative to viewport width. Measure LCP improvement in Lighthouse.
      */}
