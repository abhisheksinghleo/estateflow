  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        {/* Performance Optimization: Replaced native img with next/image inside a motion wrapper.
            Impact: Automatically optimizes image sizes, formats (e.g. WebP), and lazy-loads efficiently,
            significantly reducing LCP and bandwidth on list pages. */}
        <motion.div
