  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        >
          {/*
            ⚡ Bolt Optimization: Migrated native <img> to next/image for optimized rendering.
            What: Replaced <motion.img> with <motion.div> wrapping next/image, using 'fill' and responsive 'sizes'.
            Why: next/image provides automatic image optimization, format selection (WebP/AVIF), and prevents CLS.
            Impact: Significantly reduces LCP (Largest Contentful Paint) and image payload size.
            Measurement: Check Network tab for WebP/AVIF format and smaller image sizes, plus improved Lighthouse performance score.
          */}
          <Image
            src={image}
            alt={title}
