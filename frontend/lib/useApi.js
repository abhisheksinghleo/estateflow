 ...
 * Includes Stale-While-Revalidate (SWR) caching mechanism.
 *
 ...
 * @param {string}   cacheKey - Optional unique string for caching the result (enables SWR)
 */
export default function useApi(apiFn, deps = [], fallback = null, cacheKey = null) {
  ...
  // Derive state from props (handle dynamic route changes without unmounting)
