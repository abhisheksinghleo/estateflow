...
function RentPageContent() {
   ...
   * What: Memoize array filtering and sorting logic.
   * Why: Prevents running expensive filtering and sorting loops on every render, especially on input changes.
   * Impact: Reduces CPU blocking time and re-render duration.
   * Measurement: Compare React Profiler render times for RentPageContent when typing in the search bar.
   */
