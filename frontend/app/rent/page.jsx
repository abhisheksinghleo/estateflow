...
function RentPageContent() {
   ...
   * What: Memoize property filtering and sorting
   * Why: Prevents expensive array operations on every render (e.g. when typing in search or closing a modal),
   *      especially for complex filters applied to potentially large lists of properties.
   * Impact: Reduces CPU blocking time during re-renders, preventing input lag and UI stutter.
   * Measurement: React DevTools Profiler will show reduced render time for RentPageContent when state changes.
   */
