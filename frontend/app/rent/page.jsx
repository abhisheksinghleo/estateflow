...
function RentPageContent() {
  ...
  // What: Wrap filtering and sorting in useMemo
  // Why: Prevent expensive array operations on every render when filters/sort haven't changed
  // Impact: Reduces CPU time during component re-renders (e.g. state updates unrelated to filtering)
  // Measurement: Profile React render time before/after on a large dataset when triggering re-renders
