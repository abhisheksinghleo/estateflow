...
function AdminDashboardPageContent() {
  ...
  const { data: overview, loading: overviewLoading } = useApi(() => dashboardApi.getAdminOverview(), [], null, "admin-overview"); // Bolt: Cache overview
  const { data: propertiesList, refetch: refetchProps } = useApi(() => propertyApi.getProperties(), [], [], "admin-properties"); // Bolt: Cache property list
