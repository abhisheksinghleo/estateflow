...
function AdminDashboardPageContent() {
  ...
  const { data: overview, loading: overviewLoading } = useApi(() => dashboardApi.getAdminOverview(), [], null, "admin_overview");
  const { data: propertiesList, refetch: refetchProps } = useApi(() => propertyApi.getProperties(), [], [], "admin_properties");
