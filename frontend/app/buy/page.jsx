...
function BuyPageContent() {
  ...
  // What: Memoized complex filtering and sorting logic
  // Why: Prevents expensive array operations on every component render (e.g. when typing in an unrelated input)
  // Impact: O(N) filtering and O(N log N) sorting only runs when dependencies actually change
  // Measurement: React Profiler will show reduced render time when interacting with non-filter UI elements
